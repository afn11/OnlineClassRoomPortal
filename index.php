...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
                    Welcome to Online ClassRoom Portal
                </h1>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The “Online ClassRoom Portal” Website (web based application) is useful for the
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">Online ClassRoom Portal</h2>
		</div>
		<div class="col-md-6">
			<p><strong>Online ClassRoom Portal by AFNAN,ABHAY,AJAY</strong> includes:</p>
			<ul>
				<li><strong>Bootstrap v3.3.7</strong>
				</li>
				<li><strong>jQuery v1.11.1</strong></li>
				<li><strong>Font Awesome v4.2.0</strong></li>
				<li><strong>Working PHP with validation</strong></li>
				<li><strong>Unstyled page elements for easy customization</strong></li>
				<li><strong>65 PHP pages</strong></li>
			</ul>
...
<footer>
    ...
    <p>Email: <a href="mailto:xyz@sea.com">xyz@sea.com</a></p>
    <p>Phone: <a href="tel:+918967452310">+91 89674 52310</a></p>
</footer>
